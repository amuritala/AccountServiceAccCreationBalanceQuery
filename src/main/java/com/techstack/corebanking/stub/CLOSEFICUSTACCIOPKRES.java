 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}FICustAcc-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSEFICUSTACC_IOPK_RES")
public class CLOSEFICUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected FICustAccCloseIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link FICustAccCloseIOType }
         *     
         */
        public FICustAccCloseIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(FICustAccCloseIOType value) {
