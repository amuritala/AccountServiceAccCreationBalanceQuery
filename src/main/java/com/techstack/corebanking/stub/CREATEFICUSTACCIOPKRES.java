 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}FICustAcc-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATEFICUSTACC_IOPK_RES")
public class CREATEFICUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected FICustAccCreateIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link FICustAccCreateIOType }
         *     
         */
        public FICustAccCreateIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(FICustAccCreateIOType value) {
