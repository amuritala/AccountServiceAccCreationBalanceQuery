 ...
 *                   &lt;element name="MULTIMODE_TDOFFSET_CCY" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
public class TopUpSimFullType {
    ...
    protected List<TdtopupPayin> tdtopupPayin;
    @XmlElement(name = "Int-Payout")
    protected List<IntPayout> intPayout;
     ...
     * 
     */
    public List<TdtopupPayin> getTdtopupPayin() {
        if (tdtopupPayin == null) {
            tdtopupPayin = new ArrayList<TdtopupPayin>();
        }
     ...
     * 
     */
    public List<IntPayout> getIntPayout() {
        if (intPayout == null) {
            intPayout = new ArrayList<IntPayout>();
        }
    ...
    public static class TdtopupPayin {
        ...
        @XmlElement(name = "MULTIMODE_TDOFFSET_CCY")
        protected String multimodetdoffsetccy;
        ...
        /**
         * Gets the value of the multimodetdoffsetccy property.
         * 
         * @return
         *     possible object is
         *     {@link String }
         *     
         */
        public String getMULTIMODETDOFFSETCCY() {
            return multimodetdoffsetccy;
        }

        /**
         * Sets the value of the multimodetdoffsetccy property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setMULTIMODETDOFFSETCCY(String value) {
            this.multimodetdoffsetccy = value;
        }
