...
public class BillingprefmasterCreateIOType {
    ...
    protected Billingprefmaster billingprefmaster;
    @XmlElement(name = "Billingproducts")
    protected List<Billingproducts> billingproducts;
     ...
     * @return
     *     possible object is
     *     {@link Billingprefmaster }
     *     
     */
    public Billingprefmaster getBillingprefmaster() {
     ...
     *     
     */
    public void setBillingprefmaster(Billingprefmaster value) {
     ...
     * {@link Billingproducts }
     * 
     * 
     */
    public List<Billingproducts> getBillingproducts() {
        if (billingproducts == null) {
            billingproducts = new ArrayList<Billingproducts>();
        }
