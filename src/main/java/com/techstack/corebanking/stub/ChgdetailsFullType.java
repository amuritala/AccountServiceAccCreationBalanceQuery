...
public class ChgdetailsFullType {
    ...
    protected MiscIcchspcn miscIcchspcn;
     ...
     *     
     */
    public MiscIcchspcn getMiscIcchspcn() {
        return miscIcchspcn;
    }
     ...
     *     
     */
    public void setMiscIcchspcn(MiscIcchspcn value) {
    ...
    public static class Chgdetails {
        ...
        protected List<Chgslabs> chgslabs;
         ...
         * 
         */
        public List<Chgslabs> getChgslabs() {
            if (chgslabs == null) {
                chgslabs = new ArrayList<Chgslabs>();
            }
