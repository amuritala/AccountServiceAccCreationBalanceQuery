 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Account-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ReservedCustAcc-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Account-Master-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}ReservedCustAcc-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYRESERVEDCUSTACC_IOFS_RES")
public class QUERYRESERVEDCUSTACCIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ReservedCustAccQueryIOType accountMasterIO;
        @XmlElement(name = "Account-Master-Full")
        protected ReservedCustAccFullType accountMasterFull;
         ...
         * @return
         *     possible object is
         *     {@link ReservedCustAccQueryIOType }
         *     
         */
        public ReservedCustAccQueryIOType getAccountMasterIO() {
         ...
         *     
         */
        public void setAccountMasterIO(ReservedCustAccQueryIOType value) {
            this.accountMasterIO = value;
        }

        /**
         * Gets the value of the accountMasterFull property.
         * 
         * @return
         *     possible object is
         *     {@link ReservedCustAccFullType }
         *     
         */
        public ReservedCustAccFullType getAccountMasterFull() {
            return accountMasterFull;
        }

        /**
         * Sets the value of the accountMasterFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ReservedCustAccFullType }
         *     
         */
        public void setAccountMasterFull(ReservedCustAccFullType value) {
            this.accountMasterFull = value;
        }
