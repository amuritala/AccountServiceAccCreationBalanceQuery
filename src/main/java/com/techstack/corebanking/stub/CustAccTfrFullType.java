...
public class CustAccTfrFullType {
     ...
     * 
     */
    public List<ChargeProd> getChargeProd() {
        if (chargeProd == null) {
            chargeProd = new ArrayList<ChargeProd>();
        }
     ...
     * 
     */
    public List<ConsolCharges> getConsolCharges() {
        if (consolCharges == null) {
            consolCharges = new ArrayList<ConsolCharges>();
        }
     ...
     *     
     */
    public void setTempStatus(TempStatus value) {
     ...
     *     
     */
    public TempCharge getTempCharge() {
        return tempCharge;
    }
     ...
     *     
     */
    public void setTempCharge(TempCharge value) {
     ...
     *     
     */
    public TempConsol getTempConsol() {
        return tempConsol;
    }
     ...
     *     
     */
    public void setTempConsol(TempConsol value) {
     ...
     *     
     */
    public void setIctmAcc(IctmAcc value) {
        this.ictmAcc = value;
    }
    ...
    public static class ChargeProd {
        ...
        protected List<ChargeSlab> chargeSlab;
         ...
         * 
         */
        public List<ChargeSlab> getChargeSlab() {
            if (chargeSlab == null) {
                chargeSlab = new ArrayList<ChargeSlab>();
            }
    ...
    public static class Interest {
        ...
        protected List<UdeEffdt> udeEffdt;
        @XmlElement(name = "Temp-Int")
        protected TempInt tempInt;
         ...
         * 
         */
        public List<UdeEffdt> getUdeEffdt() {
            if (udeEffdt == null) {
                udeEffdt = new ArrayList<UdeEffdt>();
            }
         ...
         *     
         */
        public void setTempInt(TempInt value) {
            this.tempInt = value;
        }
        ...
        public static class UdeEffdt {
            ...
            protected List<UdeVals> udeVals;
             ...
             * 
             */
            public List<UdeVals> getUdeVals() {
                if (udeVals == null) {
                    udeVals = new ArrayList<UdeVals>();
                }
                return this.udeVals;
            }
