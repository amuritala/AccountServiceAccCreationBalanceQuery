...
public class TdRollHistoryFullType {
    ...
    protected List<TdRolloverhistory> tdRolloverhistory;
     ...
     * {@link TdRolloverhistory }
     * 
     * 
     */
    public List<TdRolloverhistory> getTdRolloverhistory() {
        if (tdRolloverhistory == null) {
            tdRolloverhistory = new ArrayList<TdRolloverhistory>();
        }
