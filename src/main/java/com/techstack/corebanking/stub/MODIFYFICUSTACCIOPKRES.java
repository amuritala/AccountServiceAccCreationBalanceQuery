 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}FICustAcc-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYFICUSTACC_IOPK_RES")
public class MODIFYFICUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected FICustAccModifyIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link FICustAccModifyIOType }
         *     
         */
        public FICustAccModifyIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(FICustAccModifyIOType value) {
