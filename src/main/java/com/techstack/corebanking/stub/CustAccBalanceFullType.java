...
public class CustAccBalanceFullType {
    ...
    protected List<TdAccounts> tdAccounts;
    @XmlElement(name = "Td-Details")
    protected TdDetails tdDetails;
    @XmlElement(name = "Tdamtblockmain")
    protected Tdamtblockmain tdamtblockmain;
    @XmlElement(name = "Tdamtblock")
    protected List<Tdamtblock> tdamtblock;
     ...
     * 
     */
    public List<TdAccounts> getTdAccounts() {
        if (tdAccounts == null) {
            tdAccounts = new ArrayList<TdAccounts>();
        }
     ...
     *     
     */
    public Tdamtblockmain getTdamtblockmain() {
     ...
     *     
     */
    public void setTdamtblockmain(Tdamtblockmain value) {
     ...
     * 
     */
    public List<Tdamtblock> getTdamtblock() {
        if (tdamtblock == null) {
            tdamtblock = new ArrayList<Tdamtblock>();
        }
