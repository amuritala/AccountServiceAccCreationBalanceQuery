 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}FICustAcc-Reopen-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "REOPENFICUSTACC_IOPK_RES")
public class REOPENFICUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected FICustAccReopenIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link FICustAccReopenIOType }
         *     
         */
        public FICustAccReopenIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(FICustAccReopenIOType value) {
