 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Ccy-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}McyQY-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Ccy-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}McyQY-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYMCYQY_IOFS_RES")
public class QUERYMCYQYIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Ccy-IO")
        protected McyQYQueryIOType ccyIO;
        @XmlElement(name = "Ccy-Full")
        protected McyQYFullType ccyFull;
        ...
        /**
         * Gets the value of the ccyIO property.
         * 
         * @return
         *     possible object is
         *     {@link McyQYQueryIOType }
         *     
         */
        public McyQYQueryIOType getCcyIO() {
            return ccyIO;
        }

        /**
         * Sets the value of the ccyIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyQYQueryIOType }
         *     
         */
        public void setCcyIO(McyQYQueryIOType value) {
            this.ccyIO = value;
        }

        /**
         * Gets the value of the ccyFull property.
         * 
         * @return
         *     possible object is
         *     {@link McyQYFullType }
         *     
         */
        public McyQYFullType getCcyFull() {
            return ccyFull;
        }

        /**
         * Sets the value of the ccyFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyQYFullType }
         *     
         */
        public void setCcyFull(McyQYFullType value) {
            this.ccyFull = value;
        }
