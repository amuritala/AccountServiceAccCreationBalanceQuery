...
public class DenomDepositModifyIOType {
    ...
    protected List<Demdep> demdep;
    @XmlElement(name = "Demcertificate", required = true)
    protected List<Demcertificate> demcertificate;
     ...
     * 
     */
    public List<Demdep> getDemdep() {
        if (demdep == null) {
            demdep = new ArrayList<Demdep>();
        }
        return this.demdep;
    }
     ...
     * 
     */
    public List<Demcertificate> getDemcertificate() {
        if (demcertificate == null) {
            demcertificate = new ArrayList<Demcertificate>();
        }
