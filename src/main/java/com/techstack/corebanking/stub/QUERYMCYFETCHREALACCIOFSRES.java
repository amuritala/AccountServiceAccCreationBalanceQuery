 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Query-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}McyFetchRealacc-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Query-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}McyFetchRealacc-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYMCYFETCHREALACC_IOFS_RES")
public class QUERYMCYFETCHREALACCIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Query-IO")
        protected McyFetchRealaccQueryIOType queryIO;
        @XmlElement(name = "Query-Full")
        protected McyFetchRealaccFullType queryFull;
        ...
        /**
         * Gets the value of the queryIO property.
         * 
         * @return
         *     possible object is
         *     {@link McyFetchRealaccQueryIOType }
         *     
         */
        public McyFetchRealaccQueryIOType getQueryIO() {
            return queryIO;
        }

        /**
         * Sets the value of the queryIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyFetchRealaccQueryIOType }
         *     
         */
        public void setQueryIO(McyFetchRealaccQueryIOType value) {
            this.queryIO = value;
        }

        /**
         * Gets the value of the queryFull property.
         * 
         * @return
         *     possible object is
         *     {@link McyFetchRealaccFullType }
         *     
         */
        public McyFetchRealaccFullType getQueryFull() {
            return queryFull;
        }

        /**
         * Sets the value of the queryFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyFetchRealaccFullType }
         *     
         */
        public void setQueryFull(McyFetchRealaccFullType value) {
            this.queryFull = value;
        }
