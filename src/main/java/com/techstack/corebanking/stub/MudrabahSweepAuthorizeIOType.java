...
public class MudrabahSweepAuthorizeIOType {
    ...
    protected List<SttbsSweepDetails> sttbsSweepDetails;
     ...
     * {@link SttbsSweepDetails }
     * 
     * 
     */
    public List<SttbsSweepDetails> getSttbsSweepDetails() {
        if (sttbsSweepDetails == null) {
            sttbsSweepDetails = new ArrayList<SttbsSweepDetails>();
        }
