 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Account-Master-PK" type="{http://fcubs.ofss.com/service/FCUBSAccService}ReservedCustAcc-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Account-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ReservedCustAcc-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZERESERVEDCUSTACC_IOPK_RES")
public class AUTHORIZERESERVEDCUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Account-Master-PK")
        protected ReservedCustAccPKType accountMasterPK;
        @XmlElement(name = "Account-Master-IO")
        protected ReservedCustAccAuthorizeIOType accountMasterIO;
        ...
        /**
         * Gets the value of the accountMasterPK property.
         * 
         * @return
         *     possible object is
         *     {@link ReservedCustAccPKType }
         *     
         */
        public ReservedCustAccPKType getAccountMasterPK() {
            return accountMasterPK;
        }

        /**
         * Sets the value of the accountMasterPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link ReservedCustAccPKType }
         *     
         */
        public void setAccountMasterPK(ReservedCustAccPKType value) {
            this.accountMasterPK = value;
        }

        /**
         * Gets the value of the accountMasterIO property.
         * 
         * @return
         *     possible object is
         *     {@link ReservedCustAccAuthorizeIOType }
         *     
         */
        public ReservedCustAccAuthorizeIOType getAccountMasterIO() {
            return accountMasterIO;
        }

        /**
         * Sets the value of the accountMasterIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link ReservedCustAccAuthorizeIOType }
         *     
         */
        public void setAccountMasterIO(ReservedCustAccAuthorizeIOType value) {
            this.accountMasterIO = value;
        }
