...
public class CustAccountMISFullType {
     ...
     *     
     */
    public void setChglog(Chglog value) {
        this.chglog = value;
    }
    ...
    public static class Misdetails {
        ...
        protected List<MisAccLog> misAccLog;
        @XmlElement(name = "MisBalLog")
        protected List<MisBalLog> misBalLog;
         ...
         * 
         */
        public List<MisAccLog> getMisAccLog() {
            if (misAccLog == null) {
                misAccLog = new ArrayList<MisAccLog>();
            }
         ...
         * 
         */
        public List<MisBalLog> getMisBalLog() {
            if (misBalLog == null) {
                misBalLog = new ArrayList<MisBalLog>();
            }
