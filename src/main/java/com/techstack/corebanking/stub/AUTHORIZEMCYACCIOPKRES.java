 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Multi-Ccy-Master-PK" type="{http://fcubs.ofss.com/service/FCUBSAccService}Mcyacc-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Multi-Ccy-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}Mcyacc-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZEMCYACC_IOPK_RES")
public class AUTHORIZEMCYACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Multi-Ccy-Master-PK")
        protected McyaccPKType multiCcyMasterPK;
        @XmlElement(name = "Multi-Ccy-Master-IO")
        protected McyaccAuthorizeIOType multiCcyMasterIO;
        ...
        /**
         * Gets the value of the multiCcyMasterPK property.
         * 
         * @return
         *     possible object is
         *     {@link McyaccPKType }
         *     
         */
        public McyaccPKType getMultiCcyMasterPK() {
            return multiCcyMasterPK;
        }

        /**
         * Sets the value of the multiCcyMasterPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyaccPKType }
         *     
         */
        public void setMultiCcyMasterPK(McyaccPKType value) {
            this.multiCcyMasterPK = value;
        }

        /**
         * Gets the value of the multiCcyMasterIO property.
         * 
         * @return
         *     possible object is
         *     {@link McyaccAuthorizeIOType }
         *     
         */
        public McyaccAuthorizeIOType getMultiCcyMasterIO() {
            return multiCcyMasterIO;
        }

        /**
         * Sets the value of the multiCcyMasterIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link McyaccAuthorizeIOType }
         *     
         */
        public void setMultiCcyMasterIO(McyaccAuthorizeIOType value) {
            this.multiCcyMasterIO = value;
        }
