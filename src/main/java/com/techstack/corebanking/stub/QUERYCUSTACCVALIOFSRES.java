 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Cust-Acc-Val-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAccVal-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Cust-Acc-Val-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAccVal-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCUSTACCVAL_IOFS_RES")
public class QUERYCUSTACCVALIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Cust-Acc-Val-IO")
        protected CustAccValQueryIOType custAccValIO;
        @XmlElement(name = "Cust-Acc-Val-Full")
        protected CustAccValFullType custAccValFull;
        ...
        /**
         * Gets the value of the custAccValIO property.
         * 
         * @return
         *     possible object is
         *     {@link CustAccValQueryIOType }
         *     
         */
        public CustAccValQueryIOType getCustAccValIO() {
            return custAccValIO;
        }

        /**
         * Sets the value of the custAccValIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAccValQueryIOType }
         *     
         */
        public void setCustAccValIO(CustAccValQueryIOType value) {
            this.custAccValIO = value;
        }

        /**
         * Gets the value of the custAccValFull property.
         * 
         * @return
         *     possible object is
         *     {@link CustAccValFullType }
         *     
         */
        public CustAccValFullType getCustAccValFull() {
            return custAccValFull;
        }

        /**
         * Sets the value of the custAccValFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAccValFullType }
         *     
         */
        public void setCustAccValFull(CustAccValFullType value) {
            this.custAccValFull = value;
        }
