 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Custbal-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}AcctBal-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Custbal-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}AcctBal-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYACCTBAL_IOFS_RES")
public class QUERYACCTBALIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Custbal-IO")
        protected AcctBalQueryIOType custbalIO;
        @XmlElement(name = "Custbal-Full")
        protected AcctBalFullType custbalFull;
        ...
        /**
         * Gets the value of the custbalIO property.
         * 
         * @return
         *     possible object is
         *     {@link AcctBalQueryIOType }
         *     
         */
        public AcctBalQueryIOType getCustbalIO() {
            return custbalIO;
        }

        /**
         * Sets the value of the custbalIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link AcctBalQueryIOType }
         *     
         */
        public void setCustbalIO(AcctBalQueryIOType value) {
            this.custbalIO = value;
        }

        /**
         * Gets the value of the custbalFull property.
         * 
         * @return
         *     possible object is
         *     {@link AcctBalFullType }
         *     
         */
        public AcctBalFullType getCustbalFull() {
            return custbalFull;
        }

        /**
         * Sets the value of the custbalFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link AcctBalFullType }
         *     
         */
        public void setCustbalFull(AcctBalFullType value) {
            this.custbalFull = value;
        }
