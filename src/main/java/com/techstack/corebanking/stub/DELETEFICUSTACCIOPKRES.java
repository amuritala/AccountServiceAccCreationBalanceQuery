 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}FICustAcc-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETEFICUSTACC_IOPK_RES")
public class DELETEFICUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected FICustAccDeleteIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link FICustAccDeleteIOType }
         *     
         */
        public FICustAccDeleteIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(FICustAccDeleteIOType value) {
