 ...
 *                   &lt;element name="Account-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ReservedCustAcc-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATERESERVEDCUSTACC_IOPK_RES")
public class CREATERESERVEDCUSTACCIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ReservedCustAccCreateIOType accountMasterIO;
         ...
         * @return
         *     possible object is
         *     {@link ReservedCustAccCreateIOType }
         *     
         */
        public ReservedCustAccCreateIOType getAccountMasterIO() {
         ...
         *     
         */
        public void setAccountMasterIO(ReservedCustAccCreateIOType value) {
