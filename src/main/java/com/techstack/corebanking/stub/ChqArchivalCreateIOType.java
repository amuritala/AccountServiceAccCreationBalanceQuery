...
public class ChqArchivalCreateIOType {
    ...
    protected List<CatbArchivalMasterAcc> catbArchivalMasterAcc;
     ...
     * {@link CatbArchivalMasterAcc }
     * 
     * 
     */
    public List<CatbArchivalMasterAcc> getCatbArchivalMasterAcc() {
        if (catbArchivalMasterAcc == null) {
            catbArchivalMasterAcc = new ArrayList<CatbArchivalMasterAcc>();
        }
